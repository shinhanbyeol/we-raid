...
export class AdminController {
  ...
  updateServer(@Param('gameId') gameId: string, @Param('id') id: string, @Body() dto: UpdateServerDto) {
  ...
  createEventType(@Param('gameId') gameId: string, @Body() dto: CreateEventTypeDto) {
